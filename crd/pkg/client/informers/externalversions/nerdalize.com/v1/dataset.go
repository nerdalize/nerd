...
import (
	...
	v1 "github.com/nerdalize/nerd/crd/pkg/client/listers/nerdalize.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.NerdalizeV1().Datasets(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NerdalizeV1().Datasets(namespace).Watch(options)
			},
		},
		&nerdalize_com_v1.Dataset{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *datasetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nerdalize_com_v1.Dataset{}, f.defaultInformer)
}
