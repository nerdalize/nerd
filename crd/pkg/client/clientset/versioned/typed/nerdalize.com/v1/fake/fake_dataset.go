...
import (
	nerdalize_com_v1 "github.com/nerdalize/nerd/crd/pkg/apis/nerdalize.com/v1"
...
func (c *FakeDatasets) Get(name string, options v1.GetOptions) (result *nerdalize_com_v1.Dataset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(datasetsResource, c.ns, name), &nerdalize_com_v1.Dataset{})

	if obj == nil {
		return nil, err
	}
	return obj.(*nerdalize_com_v1.Dataset), err
}

// List takes label and field selectors, and returns the list of Datasets that match those selectors.
func (c *FakeDatasets) List(opts v1.ListOptions) (result *nerdalize_com_v1.DatasetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(datasetsResource, datasetsKind, c.ns, opts), &nerdalize_com_v1.DatasetList{})
	...
	list := &nerdalize_com_v1.DatasetList{}
	for _, item := range obj.(*nerdalize_com_v1.DatasetList).Items {
...
func (c *FakeDatasets) Create(dataset *nerdalize_com_v1.Dataset) (result *nerdalize_com_v1.Dataset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(datasetsResource, c.ns, dataset), &nerdalize_com_v1.Dataset{})
...
func (c *FakeDatasets) Update(dataset *nerdalize_com_v1.Dataset) (result *nerdalize_com_v1.Dataset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(datasetsResource, c.ns, dataset), &nerdalize_com_v1.Dataset{})
...
func (c *FakeDatasets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(datasetsResource, c.ns, name), &nerdalize_com_v1.Dataset{})
...
func (c *FakeDatasets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &nerdalize_com_v1.DatasetList{})
	return err
}

// Patch applies the patch and returns the patched dataset.
func (c *FakeDatasets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *nerdalize_com_v1.Dataset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(datasetsResource, c.ns, name, data, subresources...), &nerdalize_com_v1.Dataset{})
